              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="flex-shrink-0 w-full px-4">
                  <div className="text-center py-12 px-8">
                    ...
                    <p className="text-2xl lg:text-3xl font-heading text-foreground leading-relaxed mb-10">
                      "{testimonial.quote}"
                    </p>
            ...
            <div className="flex gap-3">
              {testimonials.map((_, index) => (
                <motion.button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${index === activeIndex ? 'bg-primary w-8' : 'bg-border w-2'}`}
